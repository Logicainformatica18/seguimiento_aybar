                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="d-sm-flex align-items-center justify-space-between">
                            <h1 class="text-primary">Estados</h1>
                    ...
                    <div class="card-body">
                        <p class="card-subtitle mb-3">
                            <button type="button" class="btn mb-1 me-1 btn-success" data-bs-toggle="modal"
                                ...
                                onclick="New();$('#Status')[0].reset();Status.fotografia.src ='https://placehold.co/150';">
                                Agregar
                            </button>
                        </p>
                        <div class="mb-2">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" role="form" id="Status" name="Status"
